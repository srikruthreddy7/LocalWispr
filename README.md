...
- **[docs/ACCENT-DATA-PIPELINE.md](docs/ACCENT-DATA-PIPELINE.md)** — Current Indian-accent English data source registry, Modal audit commands, gated-source request plan, ASR bakeoffs, and backend decisions.
